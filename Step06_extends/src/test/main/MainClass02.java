 ...
 *   지역변수나 필드 앞에서 선언하는 data type 은 (참조 데이터 type)
 *   그 안에 들어있는 참조값의 사용 설명서 라고 생각하면 된다
 *   그렇기 때문에 그 지역변수나 필ㄹ드에 .을 찍으면 사용 설명서에 명시된 기능만 사용 가능
 *   java 의 모든 객체는 다형성을 가질 수 있다
 *   다형성은 type 이 여러 개 라는 의미
 * */
public class MainClass02 {
	public static void main(String[] args) {
		// HandPhone 객체를 생성해서 나은 참조값을 HandPhone type 지역변수 p1에 담기
