...
public class GamePanel extends JPanel{
	...
	public GamePanel() {
		...
		MouseMotionAdapter adaptor = new MouseMotionAdapter() {
			@Override
		...
		addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				// 만일 space 바를 누르면
				if(e.getKeyCode() == 32) {
					// Missle 객체를 생성해서 현재 unit 의 좌표를 담은 다음에 List 에 누적시키기
	...
	protected void paintComponent(Graphics g) {
	 ...
	 // ㄴ> 초당 100번 호출되는 메소드 // ㄴ> unitX, unitY 필드의 값이 변경되면 드래곤의 이미지에 바로 반영
